...
key = "AIzaSyC5gh4vowK5nG0Vzv6ZcQpmtyAxIwmwuyw"
n_call = 20
...
class downloader:
    ...
    def __init__(
        ...
        save_path = path + "labelled_backwards"
        ...
        for i in tqdm(range(len(saving_blocks))):
            ...
            log_content = "File: {0}\nChunk : {1}\n".format(file, i)
            with open("../../logs/perspectiveAPI_last_file_retrieved_backwards.txt", "w") as log_file:
