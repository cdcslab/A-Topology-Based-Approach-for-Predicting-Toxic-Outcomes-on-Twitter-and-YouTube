...
posts_filename = "/media/gabett/Volume/data-repository/panconesi-football-elections/elections/twitter/elections_twitter_data_with_in_reply_to_id_filled.RData"
comments_filename = "/media/gabett/Volume/data-repository/panconesi-football-elections/elections/twitter/elections_twitter_data_with_in_reply_to_id_filled.RData"
output_folder = "/media/gabett/Volume/data-repository/panconesi-football-elections/elections/twitter/trees/shuffled_graph_analysis_for_each_comment/"
...
for (c_id in unique_conversation_ids[i: length(unique_conversation_ids)])
{
  ...
  # Shuffling nodes
  elections_comments_by_conversation_id$in_reply_to_id <- sample(elections_comments_by_conversation_id$in_reply_to_id)
