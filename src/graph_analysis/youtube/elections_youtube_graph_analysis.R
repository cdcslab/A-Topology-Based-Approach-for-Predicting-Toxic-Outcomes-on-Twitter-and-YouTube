...
output_folder = "/media/gabett/Volume/data-repository/panconesi-football-elections/elections/youtube/trees/graph_analysis_for_each_comment"
...
i = 1
for (v_id in unique_video_ids[i:length(unique_video_ids)])
{
